...
// 25+ Curated Legitimate Free Resources (YouTube lectures, Official NBEMS guidelines, WHO/CDC resources, PubMed Open Access)
export const FREE_RESOURCES: Resource[] = [
  ...(generatedDb.resources as Resource[]),
  // PYQ PDF Mock
  {
    id: 'res_pyq_fmge_2024',
    title: 'FMGE June 2024 - Complete Authentic Question Paper with Explanations',
    description: 'Official recall questions for the FMGE June 2024 session, compiled with detailed explanations.',
    url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    source: 'Community Recalls',
    sourceType: 'PDF',
    subjectId: 'medicine',
    systemName: 'General',
    topicId: 'general',
    ...
    isFree: true,
    isVerified: true,
    author: 'FMGE Master Community',
    publishedDate: '2024-07-01',
    lastChecked: '2024-07-05',
    keyPoints: ['Covers all 300 questions', 'Includes detailed explanations', 'PDF Downloadable']
  },
  {
    id: 'res_pyq_neetpg_2023',
    title: 'NEET PG 2023 - Complete Authentic Question Paper',
    description: 'Official recall questions for NEET PG 2023.',
    url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    source: 'Community Recalls',
    sourceType: 'PDF',
    subjectId: 'medicine',
    ...
    lastChecked: '2023-04-05'
  },
  {
    id: 'res1',
    title: 'ECG Basics & Myocardial Infarction Localization',
    description: 'Comprehensive open medical video tutorial explaining 12-lead ECG principles, axis calculation, and STEMI localization with clear graphical coronary diagrams.',
    url: 'https://www.youtube.com/watch?v=kwbkgbmk-Ec',
    source: 'YouTube (Open Medical Education)',
    sourceType: 'YOUTUBE',
    subjectId: 'medicine',
    systemName: 'Cardiology & ECG',
    topicId: 'myocardial-infarction',
    ...
    duration: '22 mins',
    author: 'Ninja Nerd Science / Khan Academy Medicine Open',
    publishedDate: '2023-04-15',
    lastChecked: '2026-08-01',
    embedId: 'kwbkgbmk-Ec',
    keyPoints: [
      'Understand limb leads vs precordial leads',
      'Identify STEMI in II, III, aVF (Inferior) and V1-V4 (Anterior)',
      'Recognize reciprocal ST depressions',
      'Manage Right Ventricular Infarction with fluid preload'
    ]
  },
  {
    id: 'res2',
    title: 'WHO Clinical Management of Preeclampsia & Eclampsia Guidelines',
    description: 'Official World Health Organization guideline document outlining evidence-based protocols for Magnesium Sulfate administration, blood pressure thresholds, and delivery timing.',
    ...
    duration: '18 pages',
    author: 'WHO Reproductive Health & Research Guideline Panel',
    publishedDate: '2022-11-10',
    lastChecked: '2026-08-01',
    keyPoints: [
      'Pritchard vs Zuspan Magnesium Sulfate regimens',
      'Blood pressure cutoffs for emergency IV Labetalol or Hydralazine',
      'Indication for immediate delivery in eclampsia',
      'Calcium gluconate antidote protocol'
    ]
  },
  {
    id: 'res3',
    title: 'Epidemiological Study Designs: Cohort vs Case-Control vs Cross-Sectional',
    description: 'Peer-reviewed open access educational tutorial breaking down 2x2 contingency tables, Odds Ratio (OR), Relative Risk (RR), Attributable Risk, and common study biases.',
    url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2998589/',
    source: 'NIH / PubMed Central Open Access',
    sourceType: 'PUBMED',
    subjectId: 'psm',
    systemName: 'Epidemiology & Study Designs',
    topicId: 'epidemiology-study-designs',
    ...
    lastChecked: '2026-08-01',
    keyPoints: [
      'Differentiate prospective forward cohort from retrospective case-control',
      'Formula for Odds Ratio: (a*d)/(b*c)',
      'Calculate Relative Risk: Ie / Iu',
      'Understand Recall Bias and Berkson Selection Bias'
    ]
  },
  {
    id: 'res4',
    title: 'Brachial Plexus Anatomy & Upper Limb Nerve Injuries',
    description: 'High-definition anatomical lecture on brachial plexus root trunks, divisions, cords, and branches with clinical demonstrations of Erb and Klumpke palsies.',
    url: 'https://www.youtube.com/watch?v=kYJv5_b_g3A',
    source: 'YouTube (Open Medical Anatomy)',
    sourceType: 'YOUTUBE',
    subjectId: 'anatomy',
    systemName: 'Musculoskeletal',
    topicId: 'brachial-plexus',
    ...
    isFree: true,
    isVerified: true,
    thumbnail: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?auto=format&fit=crop&w=400&q=80',
    duration: '19 mins',
    author: 'Anatomy Zone / Open Anatomy',
    publishedDate: '2023-08-12',
    lastChecked: '2026-08-01',
    embedId: 'kYJv5_b_g3A',
    keyPoints: [
      'Mnemonic: Roots, Trunks, Divisions, Cords, Branches (Real Teens Drink Cold Beer)',
      'Erb palsy C5-C6 waiter tip deformity mechanics',
      'Klumpke palsy C8-T1 total claw hand mechanics',
      'Radial nerve course in spiral groove of humerus'
    ]
  }
];
